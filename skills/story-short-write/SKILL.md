...
| 文件 | 何时加载 |
|------|----------|
| [references/platform-writing-patterns.md](references/platform-writing-patterns.md) | **核心参考**：52,000+本真实网文数据提炼的跨平台写作模式（9种开头模式、17个题材公式、12种写作技巧、11类章尾钩子、黑岩16本男女频对比、番茄7题材长篇特征） |
